...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-laravel-elixir/node_modules/laravel-elixir/Config.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-laravel-elixir/node_modules/laravel-elixir/Config.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-laravel-elixir/node_modules/laravel-elixir/</a> &#187; Config.js</div>
</div>
<div class="body">
...
&nbsp;
            ...
            pluginOptions: {
                outputStyle: production
                    ? <span class="branch-0 cbranch-no" title="branch not covered" >'compressed'</span>
                    : 'nested',
                precision: 10
            }
        },
 ...
 * @return {string}
 */
config.get = <span class="fstat-no" title="function not covered" >function(path) {</span>
<span class="cstat-no" title="statement not covered" >    var basePath;</span>
<span class="cstat-no" title="statement not covered" >    var current = config;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (segments[0] == 'assets' || segments[0] == 'public') {</span>
<span class="cstat-no" title="statement not covered" >        basePath = config[segments.shift()+'Path'];</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    segments.forEach(<span class="fstat-no" title="function not covered" >function(segment) {</span></span>
<span class="cstat-no" title="statement not covered" >        current = current[segment];</span>
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    return p.join(basePath, current);</span>
};
&nbsp;
&nbsp;
